...
const Home = () => {
  return (
    <>
          ...
          <div className="grid-item-home">
            <div>
              ...
              <div className="button-container-home">
                <a href="/about" className="learn-more-button-home">
                  Learn More About Me
                </a>
                <a href="/projects" className="explore-projects-button-home">
                  Explore My Projects
                </a>
              </div>
            </div>
      ...
      <div className="welcome-box-home">
        <h2 className="welcome-title-home">
        ...
        <h3 className="mission-title-home">
          My Mission
        </h3>
