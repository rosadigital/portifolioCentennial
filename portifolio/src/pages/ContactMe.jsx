        ...
        <div className="grid-container-contactme">
          <div className="grid-item-contactme">
            <form>
              ...
              <button 
                type="submit" 
                className="form-button-contactme"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="grid-item-contactme">
            <div className="contact-info-contactme">
              ...
              <p className="contact-text-contactme">
                <strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/felipe-rosa/" className="contact-link-contactme">LinkedIn Profile</a>
              </p>
              <p className="contact-text-contactme">
                <strong>GitHub:</strong> <a href="https://github.com/rosadigital" className="contact-link-contactme">GitHub Profile</a>
              </p>
            </div>
          </div>
        </div>
